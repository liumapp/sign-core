...
import com.liumapp.cert.core.utils.PfxUtil;
import com.liumapp.cert.core.utils.ServerPKCSUtil;
import com.liumapp.sign.core.cert.CertInfo;
import com.liumapp.sign.core.component.RaService;
import com.liumapp.sign.core.constant.SignConstant;
import com.liumapp.sign.core.license.LicenseUtil;
import com.liumapp.sign.core.property.Properties;
import com.liumapp.sign.core.user.UserInfo;
import com.liumapp.sign.core.utils.AxisUtil;
import com.liumapp.sign.core.utils.PfxUtil;
import com.liumapp.sign.core.utils.ServerPKCSUtil;
...
public class TWCertTest extends TestCase {
    ...
    public void testPfxToJKS () throws UnrecoverableKeyException, CertificateException, NoSuchAlgorithmException, KeyStoreException {
        ...
        pfxUtil.Pfx2OldJKS(properties.getString(SignConstant.cert_PfxSavePath) + "4BBDC076D4493B52209B17643FB85B00BAA58522.pfx",
                "password",
                properties.getString(SignConstant.save_KeyStorePath) + "demo.ks",
                "123456",null);
    }
